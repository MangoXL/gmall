...
public class PmsProductAttributeCategoryController {
    ...
    public Object create(@RequestParam String name) {
        ...
        //添加商品属性分类
        Integer data = productAttributeCategoryService.create(name);
    ...
    public Object update(@PathVariable Long id, @RequestParam String name) {
        //修改商品属性分类
        Integer data = productAttributeCategoryService.updateByIdAndName(id,name);
        return new CommonResult().success(data);
    }
    ...
    public Object delete(@PathVariable Long id) {
        //删除单个商品属性分类
        Integer data = productAttributeCategoryService.deleteSingle(id);
        return new CommonResult().success(data);
    }
    ...
    public Object getList(@RequestParam(defaultValue = "5") Integer pageSize, @RequestParam(defaultValue = "1") Integer pageNum) {
        //分页获取所有商品属性分类
        HashMap<String,Object> data = productAttributeCategoryService.getPageList(pageNum,pageSize);
        return new CommonResult().success(data);
    }
    ...
    public Object getListWithAttr() {
        //获取所有商品属性分类及其下属性
        List<PmsProductAttributeCategoryItem> data = productAttributeCategoryService.getListWithAttr();
        return new CommonResult().success(data);
    }
}
